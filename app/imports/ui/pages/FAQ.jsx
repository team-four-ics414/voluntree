...
// Need to update link once search features are implemented
// -Search
// -Dashboard
      ...
      <Col xs={12} className="d-flex flex-column justify-content-center">
        ...
        <Accordion defaultActiveKey="0" className="faq-accordion">
          <Accordion.Item eventKey="0">
            ...
            <Accordion.Body>
              You can browse our website and use <a href="./">Search</a> to find volunteering opportunities near you. Filter results based on your interests, skills, and availability.
            </Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="2">
            ...
            <Accordion.Body>
              To sign up, <a href="./signup">create an account</a> an account on our website, browse available opportunities, and click on &quot;Apply&quot; for the ones you&apos;re interested in.
          ...
          <Accordion.Item eventKey="4">
            ...
            <Accordion.Body>
              Once you&apos;ve volunteered, log in to your account and navigate to the <a href="./">My Profile</a>  or <a href="./">Dashboard</a>  section. You can view and track your volunteer hours there.
            </Accordion.Body>
          </Accordion.Item>
        </Accordion>
      </Col>
