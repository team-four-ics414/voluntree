...
const ListNonprofitAdmin = () => {
  // useTracker connects Meteor data to React components. https://guide.meteor.com/react.html#using-withTracker
  const { ready, nonprofits } = useTracker(() => {
    // Note that this subscription will get cleaned up
    // when your component is unmounted or deps change.
    // Get access to Stuff documents.
    const subscription = Nonprofits.subscribeNonprofitAdmin();
  ...
  return (ready ? (
    <Container id={PAGE_IDS.LIST_NONPROFIT_ADMIN} className="py-3">
      <Row className="justify-content-center">
        <Col md={7}>
          <Col className="text-center">
            <h2>List Nonprofits (Admin)</h2>
          </Col>
        </Col>
      </Row>
...
export default ListNonprofitAdmin;
