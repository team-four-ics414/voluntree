...
const getAvatarUrl = (userId, currentUserProfile) => {
  if (userId === Meteor.userId()) {
    return currentUserProfile?.picture || '/images/defaultuserprofile.png';
  }
  return UserProfiles.findOne({ userID: userId })?.picture || '/images/defaultuserprofile.png';
};
    ...
    <div className="w-full md:w-6/12 lg:w-7/12 xl:w-7/12 px-2">
      <div className="mask-custom rounded-2xl p-4 overflow-auto" style={{ maxHeight: '80vh' }}>
        {messages.map((message) => {
          ...
          const avatarUrl = getAvatarUrl(message.senderId, currentUserProfile);
...
ConversationDetails.propTypes = {
  ...
  currentUserProfile: PropTypes.shape({
    ...
    // Add other properties of currentUserProfile you use
  }),
};
